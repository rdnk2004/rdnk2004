#!/usr/bin/env python3
"""
generate_skills_svg.py — The Director's Cut: Technical Arsenal & Applied Skill Matrix SVG
...
def render_panel(cat, x, y, idx, t):
    ...
    # Skill Badges Layout in 3 neat columns / rows
    skills = cat["skills"]
    # We will lay out skills as sleek, high-end interactive pill modules
    # 2 columns of skills inside the card: Left Col (x=16..286), Right Col (x=292..562)
